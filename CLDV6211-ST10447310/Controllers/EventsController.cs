...
namespace CLDV6211_ST10447310.Controllers
{
    public class EventsController : Controller
    {
        ...
        public EventsController(CLDV6211_ST10447310Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            // Check if the event has any active bookings
            bool hasBookings = await _context.Booking.AnyAsync(b => b.EventID == id);
            if (hasBookings)
            {
                ModelState.AddModelError(string.Empty, "Cannot delete this event. It has associated bookings.");
                return View(events);
            }
